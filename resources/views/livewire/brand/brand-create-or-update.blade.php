    ...
    <form class="row" wire:submit.prevent="save">
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                    <div class="mb-3">
                        <x-admin.input id="brandName" label="Название производителя" name="brand.name" placeholder="Название производителя"></x-admin.input>
                    </div>

                    <div class="mb-3">
                        <x-admin.switcher id="brandStatus" label="Статус" name="brand.status"></x-admin.switcher>
                    </div>
