@foreach( $store['menu_footer'] as $column => $menu )
    <h3 class="h4">Колонка {{ $loop->index }}</h3>
        ...
        @foreach($menu as $item)
            <tr>
                ...
                <td class="table-action">
                    <a href="#" wire:click.prevent="removeMenuItem('menu_footer.{{ $column }}.{{ $loop->index }}')">
    ...
    <button type="button" class="btn btn-primary" wire:click.prevent="addMenuItem('menu_footer.{{ $column }}')">
