<table class="table table-striped">
    ...
    <tbody>
    @foreach( $store['menu_top'] as $menu )
        <tr>
            <td>{{ $loop->index }}</td>
            <td>
                <x-admin.input
            ...
            <td class="table-action">
                <a href="#" wire:click.prevent="removeMenuItem('menu_top.{{ $loop->index }}')">
...
<button type="button" class="btn btn-primary" wire:click.prevent="addMenuItem('menu_top')">
