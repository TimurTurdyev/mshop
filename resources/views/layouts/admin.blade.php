    ...
    <nav id="sidebar" class="sidebar js-sidebar">
        <div class="sidebar-content js-simplebar">
            <a class="sidebar-brand" href="index.html">
                <span class="align-middle">PrvOffice</span>
            </a>
            ...
            <ul class="sidebar-nav">
                ...
                <li class="sidebar-item {{ (request()->is('admin/catalog*')) ? 'active' : '' }}">
                    <a class="sidebar-link" href="{{ route('admin.catalog') }}">
                        <i class="align-middle" data-feather="list"></i> <span class="align-middle">Категории</span>
                    </a>
                </li>

                <li class="sidebar-item {{ (request()->is('admin/brand*')) ? 'active' : '' }}">
                    <a class="sidebar-link" href="{{ route('admin.brand') }}">
                        <i class="align-middle" data-feather="box"></i> <span class="align-middle">Производители</span>
                    </a>
                </li>

                <li class="sidebar-item {{ (request()->is('admin/group*')) ? 'active' : '' }}">
                    <a class="sidebar-link" href="{{ route('admin.group') }}">
                ...
                <ul class="navbar-nav navbar-align">
                        ...
                        <div class="dropdown-menu dropdown-menu-lg dropdown-menu-end py-0"
                            ...
                            <div class="list-group">
                                <a href="#" class="list-group-item">
                                    <div class="row g-0 align-items-center">
                                        <div class="col-2">
                                            <img src="{{ asset('/dist/') }}img/avatars/avatar-5.jpg" class="avatar img-fluid rounded-circle"
                                                 alt="Vanessa Tucker">
                                        </div>
                                ...
                                <a href="#" class="list-group-item">
                                    <div class="row g-0 align-items-center">
                                        <div class="col-2">
                                            <img src="{{ asset('/dist/') }}img/avatars/avatar-2.jpg" class="avatar img-fluid rounded-circle"
                                                 alt="William Harris">
                                        </div>
                                        <div class="col-10 ps-2">
                                ...
                                <a href="#" class="list-group-item">
                                    <div class="row g-0 align-items-center">
                                        <div class="col-2">
                                            <img src="{{ asset('/dist/') }}img/avatars/avatar-4.jpg" class="avatar img-fluid rounded-circle"
                                                 alt="Christina Mason">
                                        </div>
                                        <div class="col-10 ps-2">
                                ...
                                <a href="#" class="list-group-item">
                                    <div class="row g-0 align-items-center">
                                        <div class="col-2">
                                            <img src="{{ asset('/dist/') }}img/avatars/avatar-3.jpg" class="avatar img-fluid rounded-circle"
                                                 alt="Sharon Lessman">
                                        </div>
                                        <div class="col-10 ps-2">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <a class="nav-link dropdown-toggle d-none d-sm-inline-block" href="#" data-bs-toggle="dropdown">
                            <img src="{{ asset('/dist/') }}img/avatars/avatar.jpg" class="avatar img-fluid rounded me-1" alt="Charles Hall"/>
